<h2><?php _e('Add New People Category', 'event_espresso'); ?></h2>
<p>
<?php _e('This page allows you to create a people category.', 'event_espresso'); ?>
</p>
<p>
<ul>
<li>
<strong><?php _e('Category Name', 'event_espresso'); ?></strong><br />
<?php _e('This is the name of the people category.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Unique ID', 'event_espresso'); ?></strong><br />
<?php _e('This is the unique name for a people category.', 'event_espresso'); ?>
</li>
<li>
<strong><?php _e('Category Description', 'event_espresso'); ?></strong><br />
<?php _e('The rich text editor can be used to create a description for your people category.', 'event_espresso'); ?>
</li>
</ul>
</p>
<p>
