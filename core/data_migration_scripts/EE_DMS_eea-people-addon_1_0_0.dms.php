 ...
 *
 */
class EE_DMS_eea-people-addon_1_0_0 extends EE_Data_Migration_Script_Base{

	public function __construct() {
		$this->_pretty_name = __("Data Migration to eea-people-addon 0.0.2", "event_espresso");
	...
	public function schema_changes_before_migration() {
		...
		$this->_table_is_new_in_this_version('esp_eea-people-addon_attendee_meta', '
