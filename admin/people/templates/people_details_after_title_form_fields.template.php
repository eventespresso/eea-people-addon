...
<div id="titlediv">
	<div id="titlewrap">
		...
		<input type="text" class="smaller-text-field" name="PER_lname" value="<?php echo $people->get('PER_lname'); ?>" id="PER_lname" placeholder="<?php _e('Last Name', 'event_espresso'); ?>" required>
